...
EC2_EXCHANGE_1 = EC2Config(
    ...
    EC2_SUBNET_NAME='app-private',  # Spesify Subnet name if none will be selected randomly
...
EC2_EXCHANGE_2 = EC2Config(
    ...
    EC2_SG_ID= None,
    AMI_REGION='eu-central-1',
    EC2_SUBNET_NAME='ec2-private',  # Spesify Subnet name if none will be selected randomly
...
DC_SERVER_1 = EC2Config(
    ...
    EC2_SG_ID= None,
    AMI_REGION='eu-central-1',  
    EC2_SUBNET_NAME= None,   # Spesify Subnet name if none will be selected randomly
